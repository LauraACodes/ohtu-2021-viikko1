...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tilanneLuonninJalkeen(olutta, mehua);
        mehuaOtetaanJaLisataan(mehua);
        virhetilanteet();
        lisaaOluttaJaMehuaVarastoon(olutta, mehua);
        otetaanOluttaJaMehuaVarastoista(olutta, mehua);

    }

    public static void tilanneLuonninJalkeen(Varasto olutta, Varasto mehua) {
    ...
    public static void mehuaOtetaanJaLisataan(Varasto mehua){
    ...
    public static void virhetilanteet() {
    ...
    public static void lisaaOluttaJaMehuaVarastoon(Varasto olutta, Varasto mehua) {
    ...
    public static void otetaanOluttaJaMehuaVarastoista(Varasto olutta, Varasto mehua) {
